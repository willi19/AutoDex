...
def extract_frame_from_experiments(base_path, frame_offset=10):
    ...
    for idx, exp_dir in enumerate(exp_dirs):
        video_path = exp_dir / "videos" / "25305463.avi"
...
if __name__ == "__main__":
    base_path = "/home/mingi/shared_data/RSS2026_Mingi/experiment/selected_100/attached_container"
    extract_frame_from_experiments(base_path, frame_offset=10)