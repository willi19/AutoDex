...
class Renderer(ViserViewer):
    ...
    def load_scene(self):
        ...
        if self.current_scene_type == "wall":
            ...
            scene = get_box_scene(
                obj_name=self.current_obj,
                tabletop_pose=tabletop_pose,
                height_offset=cfg["meta"]["param"]["height_offset"],
                z_scene_theta=0.0,
            )
    ...
    def _load_current_grasp(self):
        ...
        traj_dict = {}
        grasp_list = ["161", "148", "142", "116", "130"]
...
if __name__ == "__main__":
    version = "v3"
    obj_name = "green_cactus_vase"
    scene_type = "box"
    scene_idx = "2"
    vis = Renderer(version, obj_name, scene_type, scene_idx)
    vis.start_viewer()

    # spray_bottle, box, 1 [5, 7, 10, 15]
    # white_watering_can, box, 7 [76, 77]
    # container_pink, box, 10 [40, 48, 51, 54]
    # wateringcan, box, 1 [10, 12, 17, 18, 19]
    # green_cactus_vase, 2, 