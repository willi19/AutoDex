...
def parse_allegro1(allegro_traj):
    ...
    ret_allegro_traj[:, 0] = allegro_traj[:, 5] # index 
    ...
    ret_allegro_traj[:, 5] = allegro_traj[:, 6] # middle
    ...
    ret_allegro_traj[:, 12] = allegro_traj[:, 8] # thumb 
    ret_allegro_traj[:, 13] = allegro_traj[:, 15] # thumb
...
def parse_allegro(allegro_traj):
    ...
    ret_allegro_traj[:, 0] = allegro_traj[:, 12] # index 
    ret_allegro_traj[:, 1] = allegro_traj[:, 13] # index
    ret_allegro_traj[:, 2] = allegro_traj[:, 14] # index
    ret_allegro_traj[:, 3] = allegro_traj[:, 15] # index

    ret_allegro_traj[:, 4] = allegro_traj[:, 8] # middle
    ret_allegro_traj[:, 5] = allegro_traj[:, 9] # middle
    ret_allegro_traj[:, 6] = allegro_traj[:, 10] # middle
    ret_allegro_traj[:, 7] = allegro_traj[:, 11] # middle
    
    ret_allegro_traj[:, 8] = allegro_traj[:, 0] # last
    ret_allegro_traj[:, 9] = allegro_traj[:, 1] # last
    ret_allegro_traj[:, 10] = allegro_traj[:, 2] # last
    ret_allegro_traj[:, 11] = allegro_traj[:, 3] # last

    ret_allegro_traj[:, 12] = allegro_traj[:, 4] # thumb 
    ret_allegro_traj[:, 13] = allegro_traj[:, 5] # thumb
    ret_allegro_traj[:, 14] = allegro_traj[:, 6] # thumb
    ret_allegro_traj[:, 15] = allegro_traj[:, 7] # thumb
...
class Renderer(ViserViewer):
    def __init__(self, version, obj_name, exp_idx, obj_T):
        ...
        hand_traj = np.load(os.path.join(exp_dir, "hand", "action.npy"))
...
if __name__ == "__main__":
    ...
    obj_name = "toothbrush_holder"
    exp_idx = "20260121_210148"
